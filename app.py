...
st.sidebar.write("Upload HR PDFs/TXT into the `docs/` folder in this GitHub repo.")
st.sidebar.write("Then click **Rebuild index**.")
...
if st.sidebar.button("Rebuild index"):
    ...
    if vectorstore:
        ...
        st.sidebar.warning("No documents found in /docs. Add some PDFs/TXT first.")
...
if user_q:
    ...
    vectorstore = get_vectorstore()
    if not vectorstore:
        answer = "I don’t have any documents yet. Add HR documents into the **/docs** folder in GitHub, then click **Rebuild index**."
...
Answer using ONLY the provided context. If the context doesn't contain the answer, say you don't know and ask what document to check.
